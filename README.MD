...
|[19](https://leetcode.com/problems/remove-nth-node-from-end-of-list/)|Remove Nth Node From End of List | [link](pkg/leetcode/linkedlist/19.rem_nth_node_f_end.go)| Linked List Iterative|
